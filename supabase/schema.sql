...
INSERT INTO public.products (category_id, name, slug, name_telugu, description, image_url, price_250g, price_500g, price_1kg, is_active, is_best_seller, is_veg, is_price_tbd) VALUES
    ...
    ('00000000-0000-0000-0000-000000000001', 'Magai', 'magai', 'మాగాయ', 'Sun-dried mango pieces pickled with aromatic spices and oil. A beloved Andhra classic with intense flavor that deepens with age.', '/images/products/magai.jpg', 120.00, 240.00, 480.00, true, true, true, false),
    ...
    ('00000000-0000-0000-0000-000000000001', 'Villulli (Garlic)', 'villulli-garlic', 'వెల్లుల్లి', 'Whole garlic cloves pickled in spiced oil with a rich, pungent flavor. A powerhouse of taste that pairs perfectly with hot rice and ghee.', '/images/products/villulli-garlic.jpg', 150.00, 300.00, 600.00, true, true, true, false),
    ...
    ('00000000-0000-0000-0000-000000000003', 'Dhaniyalu Karam Podi (200g)', 'dhaniyalu-karam-podi', null, 'Authentic Dhaniyalu Karam Podi made with traditional Godavari recipe.', '/images/products/dhaniyalu-karam-podi.jpg', 110.00, 220.00, 440.00, true, false, true, false),
    ...
    ('00000000-0000-0000-0000-000000000003', 'Kandi Podi (200g)', 'kandi-podi', null, 'Authentic Kandi Podi made with traditional Godavari recipe.', '/images/products/kandi-podi.jpg', 120.00, 240.00, 480.00, true, false, true, false),
    ...
    ('00000000-0000-0000-0000-000000000004', 'Pumpkin Seeds', 'pumpkin-seeds', null, 'Premium quality Pumpkin Seeds packed with nutrients.', '/images/products/pumpkin-seeds.jpg', 160.00, 320.00, 640.00, true, false, true, false),
    ...
    ('00000000-0000-0000-0000-000000000004', 'Flax Seeds', 'flax-seeds', null, 'Premium quality Flax Seeds packed with nutrients.', '/images/products/flax-seeds.jpg', 125.00, 250.00, 500.00, true, false, true, false),
    ('00000000-0000-0000-0000-000000000005', 'Bellam Mamidi Thandra', 'bellam-mamidi-thandra', null, 'Traditional and sweet Bellam Mamidi Thandra.', '/images/products/bellam-mamidi-thandra.jpg', 90.00, 180.00, 360.00, true, false, true, false),
    ('00000000-0000-0000-0000-000000000005', 'Sugar Mamidi Thandra', 'sugar-mamidi-thandra', null, 'Traditional and sweet Sugar Mamidi Thandra.', '/images/products/sugar-mamidi-thandra.jpg', 90.00, 180.00, 360.00, true, false, true, false),
